...
export default function Skills() {
  ...
  return (
    <section
      id="skill"
      className="w-full bg-gradient-to-br from-white to-gray-50 dark:from-neutral-950 dark:to-neutral-900 font-sans md:px-10"
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        >
          ...
          <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-md mb-8">
            My professional expertise and the tools I use to create impactful
            marketing strategies that drive results.
          </p>

          <Tabs defaultValue="skills" className="w-full">
            <TabsList className="mb-6 bg-neutral-100 dark:bg-neutral-900 rounded-full p-1">
              <TabsTrigger
                value="skills"
                className="data-[state=active]:bg-green-500 data-[state=active]:text-white rounded-full transition-all duration-300"
              >
                Skills
              </TabsTrigger>
              <TabsTrigger
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-6">
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-white dark:bg-neutral-800 p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300"
                  >
                    <div className="mb-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                {[
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-white dark:bg-neutral-800 p-4 rounded-lg border border-gray-100 dark:border-neutral-700 shadow-sm hover:shadow-md hover:translate-y-1 transition-all duration-300 flex items-center gap-3"
                  >
